...
def get_fail_constraint():
    ...
    user_constraint.storage.min_value = 600
    user_constraint.storage.max_value = 1200
    user_constraint.storage.priority = 6
    user_constraint.screen_size.min_value = 16
    user_constraint.screen_size.max_value = 18
    user_constraint.screen_size.priority = 4
    user_constraint.weight.min_value = 1
    user_constraint.weight.max_value = 1.5
    user_constraint.weight.priority = 3
    user_constraint.price.min_value = 8000
